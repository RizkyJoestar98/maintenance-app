        ...
        <thead>
            <tr>
                <th scope="col" colspan="3" style="border: 1px solid black; text-align: center;">
                    <h4><?= $material_code['code_material'] ?></h4>
                </th>
                <th scope="col" style="border: 1px solid black; text-align: center;">
                    <img src="https://cdn.icon-icons.com/icons2/2402/PNG/512/isuzu_logo_icon_145817.png"
                        alt="logo-isuzu.png" width="50" height="50">
                </th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td colspan="3" style="border: 1px solid black; text-align: center;">
                    <h4><?= $material_code['code_category'] ?></h4>
                    <h4>
                        <?php
                                // Pastikan $material_code adalah string sebelum memanggil fungsi getBarcode
                                $material_code_str = strval($material_code['code_material']);
