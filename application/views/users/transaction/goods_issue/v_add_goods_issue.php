            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= site_url('admin/goods_issue') ?>">Goods Issue</a>
                        </li>
    ...
    <section class="content">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="quantity">Quantity GI</label>
        ...
        success: function(response) {
            ...
            $.each(response.material, function(key, value) {
                $('#code_material').append('<option value="' + value.code_material + '">' +
                    value.code_material + ' ' + value.specification_material +
                    '</option>');
            });
        },
