...
<div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= site_url('users/area') ?>">Area</a>
                        </li>
    ...
    <section class="content">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <?= form_open('users/save_area', array('id' => 'form_add_area')) ?>
            <div class="card-body">
        ...
        $('#form_add_area').validate({
            rules: {
                code_area: {
                    required: true,
                    remote: {
                        url: "<?= site_url('users/check_code_area') ?>",
                        type: "POST",
                        data: {
                            'code_area': function() {
