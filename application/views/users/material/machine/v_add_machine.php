...
<div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= site_url('users/machine') ?>">Machine</a>
                        </li>
    ...
    <section class="content">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <?= form_open('users/save_machine', array('id' => 'form_add_machine')) ?>
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="code_machine" name="code_machine" placeholder="Enter Code Machine">
                </div>
                <div class="form-group">
                    <label for="name_machine">Name Machine</label>
                    <input type="text" class="form-control" id="name_machine" name="name_machine" placeholder="Enter Name Machine">
                </div>
            </div>
            <!-- /.card-body -->
        ...
        $('#form_add_machine').validate({
            rules: {
                ...
                code_machine: {
                    required: true,
                    remote: {
                        url: "<?= site_url('users/check_code_machine') ?>",
                        type: "POST",
                        data: {
