...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <?= form_open('admin/save_line', array('id' => 'form_add_line')) ?>
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="code_line" name="code_line"
                        placeholder="Enter Code Line">
                </div>
                <div class="form-group">
    ...
    $('#form_add_line').validate({
        rules: {
            ...
            code_line: {
                required: true,
                remote: {
                    url: "<?= site_url('admin/check_code_line') ?>",
                    type: "POST",
                    data: {
                        'code_line': function() {
