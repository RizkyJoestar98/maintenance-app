    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h2 class="card-title">
                    <a href="<?= site_url('admin/add_line') ?>" class="btn btn-primary"><i
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button type="button" class="btn btn-info" data-toggle="modal"
                                    data-target="#update_line_<?= $value->id_line; ?>">
                                    <i class="fas fa-edit mr-2"></i>Update
                                </button>
                                <button type="button" class="btn btn-danger" id="delete_line"
                                    data-id-line="<?= $value->id_line; ?>" data-code-line="<?= $value->code_line; ?>"><i
...
<div class="modal fade" id="update_line_<?= $value->id_line; ?>" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="card-body">
                <input type="hidden" class="form-control" id="id_line<?= $value->id_line; ?>" name="id_line"
                    placeholder="Enter Code Line" value="<?= $value->id_line; ?>">
                <input type="hidden" class="form-control code_area" id="code_area<?= $value->id_line; ?>"
                    name="code_area" placeholder="Enter Code Line" value="<?= $value->code_area; ?>" readonly>
                <div class="form-group">
                    <label>Area</label>
                    <select class="form-control select2" id="area_<?= $value->id_line; ?>" name="area"
                        style="width: 100%;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control area_now" id="area_now<?= $value->id_line; ?>"
                        name="area_now" placeholder="Enter Code Line" value="<?= $value->name_area; ?>" readonly>
                </div>
                <div class="form-group">
                    <label for="code_line<?= $value->id_line; ?>">Code Line</label>
                    <input type="text" class="form-control" id="code_line<?= $value->id_line; ?>" name="code_line"
                        placeholder="Enter Code Line" value="<?= $value->code_line; ?>">
                </div>
                <div class="form-group">
                    <label for="name_line<?= $value->id_line; ?>">Name Line</label>
                    <input type="text" class="form-control" id="name_line<?= $value->id_line; ?>"
                        value="<?= $value->name_line ?>" name="name_line" placeholder="Enter Name Line">
                </div>
            </div>
            <!-- /.card-body -->
