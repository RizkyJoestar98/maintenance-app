...
<div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= site_url('admin/location') ?>">Location</a>
                        </li>
    ...
    <section class="content">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <?= form_open('admin/save_location', array('id' => 'form-add-location')) ?>
            <div class="card-body">
        ...
        $('#form-add-location').validate({
            rules: {
                code_location: {
                    required: true,
                    remote: {
                        url: "<?= site_url('admin/check_code_location') ?>",
                        type: "POST",
                        data: {
